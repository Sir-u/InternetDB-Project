...
<script>
    ...
    <%
        ...
        try {
            ...
            String sql = "SELECT USRNAME, PASSWORD, TITLE, MEMO FROM board WHERE NUM=" + idx;
                  ...
                  <tr>
                     <td>
                        ...
                        <table class="table table-bordered">
                           ...
                           <%	
								int authorityLevel = (int) session.getAttribute("authority_level");
								int stdnum = (int) session.getAttribute("id");
								if (authorityLevel >= 1) {
								%>
								    <tr>
								        <td class="table-info" align="center" width="76">비밀번호</td>
								        <td width="319">
								            <input class="form-control" type="password" name="password" size="40" maxlength="50" id="studentPassward" value="<%= password %>" readonly>
								        </td>
								    </tr>
								<%
								} else {
