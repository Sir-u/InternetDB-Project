...
@media ( max-width : 768px) {
	...
	input[name="title"], input[name="name"], input[type="password"], input[name="memo"]
		{
		width: 100%;
		max-width: 200px;
	}
...
<script>
   ...
   <nav>
    ...
    <main>
      <h2 class="link-offset-2" style="color: #555;">답글 작성</h2>
      <div class="table-container">
         <div class="table-responsive m-2">
            <table class="table table-secondary">
               <form name="writeform" method="post" action="reply_ok.jsp">
                  <tr>
                     <td>
                        <table class="table table-bordered">
                           <tr style="text-align:center;">
                              <td class="table-primary">답글 작성</td>
                           </tr>
                        </table>
                        ...
                        <table class="table table-bordered">
                           <tr>
                              ...
                              <td width="319">
                                 <input name="name" size="40" maxlength="50" id="studentName" required>
                           ...
                           <tr>
                              ...
                              <td width="319">
                                 <textarea name="memo" id="content" cols="60" rows="13"></textarea>
                           ...
                           <tr align="center">
                              <td colspan="2" width="399">
                                 ...
                                 <input type="submit" value="등록" class="btn btn-outline-success" onclick="writeReplyCheck();">
